 ...
 * declared "series animales : Animal" with NO size (Telegram 7/08 18:42), and
 * the size arrives later, when the variable is created, as "animales: Animal[7]".
 * Without this flag the analyzer cannot tell that form apart from a plain value.
 */
